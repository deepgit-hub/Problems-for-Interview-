...
Process details for 10 riders
Check:
If rider is underage (<18) → mark and skip further checks
If rider is not wearing a helmet → count fine
If rider does not have a license → count fine

Finally, display a report showing:
